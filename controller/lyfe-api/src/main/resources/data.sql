...
VALUES (1, 0, NOW(), NOW(), NULL, 'user2@example.com', 'hashedpassword2', 'nickname2', 'ADMIN', 'ACTIVE');
...
INSERT INTO board ( created_at, updated_at, user_id, topic_id, board_type, content, title)
VALUES ( NOW(), NOW(), 1, 1, 'BOARD', 'Conent', 'title');


INSERT INTO image (height, width, board_id, created_at, updated_at, user_id, type, url)
VALUES (200,  300, null, NOW(), NOW(), 1, 'BOARD', 'http://example.com/image1.jpg');
